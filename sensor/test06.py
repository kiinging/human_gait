...
# this version is to sample data at 4mS (which is higher the text05.py)
# this version bypass fusion algorithm
# the purpose is to replicate results from https://github.com/daehwa/Gait-Tracking-With-x-IMU-Python
...
def demo():
    ...
    while True:
        accel_raw, gyro_raw, mag_raw = read_sensor()
